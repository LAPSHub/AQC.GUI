...
class MainFrame ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.m_staticText9 = wx.StaticText( self, wx.ID_ANY, u"Gráficos", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText9.Wrap( -1 )
		bSizer1.Add( self.m_staticText9, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.m_checkBox22 = wx.CheckBox( self, wx.ID_ANY, u"Traçar Gráficos", wx.DefaultPosition, wx.DefaultSize, 0 )
